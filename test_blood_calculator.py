...
@pytest.mark.parametrize("HDL_input, expected", [(65, 'Normal'), (45, 'Borderline Low'), (20, "Low")])
...
@pytest.mark.parametrize("LDL_input, expected", [(191, 'Very High'), (167, 'High'), (135, "Borderline High"), (110, "Normal")])
